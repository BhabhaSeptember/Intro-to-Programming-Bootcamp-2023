...
// console.log(result);   //Supposed to LOG ( "9" + "undefined" )


 // let addTwoNumbers = (x, y) => console.log("1. " + (x + y));

 // let result = addTwoNumbers(4, 5);
 // console.log( "2. " + result); //outputs defined, nothing inserted to store function of adding two numbers


 // function addTwoNumbers(x, y) { //function for the above code 
 //     return x + y;
 // }
 ...
 //     let val1 = i * 5;
 //     let val2 = i * i;
 //     let response = calculate(val1, val2, "+");
 ...
 // let result = addTwoNumbers(12, 15); //returning single line function
 // console.log(result);


 // let addTwoNumbers = (x, y) => {
 //     console.log("Adding...");
 //     return x + y;  //returning a multi-line function
 //     }
...
//      console.log("Not available here:", x);
    ...
    //      console.log("Not available here:", y);
     //NOTE: Function paramaters & Local variables inside a function are not available outside of a function (in scope vs out of scope)
